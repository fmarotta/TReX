...
The argument to --ld is `genotypes/ld_dataset/chr7`. This means that the
following three files must exist:
1. `genotypes/ld_dataset/chr7.bed`
1. `genotypes/ld_dataset/chr7.bim`
1. `genotypes/ld_dataset/chr7.fam`
